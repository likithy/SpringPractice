...
public class ToDoService {
  ...
  static {
    toDos.add(new ToDo(toDosCount++, "Likith", "Learn Spring Boot", LocalDate.now().plusMonths(3), false));
    toDos.add(new ToDo(toDosCount++, "Likith", "Learn AWS", LocalDate.now().plusMonths(3), false));
    toDos.add(new ToDo(toDosCount++, "Likith", "Learn Scala", LocalDate.now().plusMonths(3), false));
  }
